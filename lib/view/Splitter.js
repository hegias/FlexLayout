...
var Splitter = /** @class */ (function (_super) {
    ...
    Splitter.prototype.render = function () {
        ...
        return React.createElement("div", { dataTest: style.width, style: style, onTouchStart: this.onMouseDown.bind(this), onMouseDown: this.onMouseDown.bind(this), className: cm("flexlayout__splitter " + OrientationStyle) });
    };
    return Splitter;
}(React.Component));
